/**
 * FYNP Home Loans Screen
 * Displays home loan offers from multiple lenders
 */
...
const HomeLoansScreen = ({navigation}) => {
  const [activeTab, setActiveTab] = React.useState('Home Loan');
  ...
  const lenders = [
    {
      ...
      description: 'Quick approval, wide network',
      rate: '8.35',
    ...
    {
      id: 2,
      name: 'Avanse Home Finance',
      description: 'Flexible EMIs for homeowners',
      rate: '8.75',
    ...
    {
      id: 3,
      name: 'IDFC FIRST Home Loan',
      description: 'Digital, low paperwork',
      rate: '8.60',
      maxAmount: 'Up to ₹5 Cr',
      badge: null,
      badgeColor: '#8b5cf6',
    ...
    },
    {
      id: 4,
      name: 'SBI Home Loan',
      description: 'Popular government bank',
      rate: '8.50',
      maxAmount: 'Up to ₹7 Cr',
      badge: null,
      badgeColor: '#06b6d4',
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Top Home Loan Lenders</Text>
          <Text style={styles.sectionDesc}>
            Compare home loan offers from India's best banks & NBFCs.
          </Text>
        </View>
            ...
            <TouchableOpacity key={lender.id} style={styles.lenderCard}>
              ...
              <View style={styles.cardActions}>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    navigation.navigate('HomeLoanDetails', {
                      lenderData: lender,
                    })
                  }
                >
        ...
        <View style={styles.trustFooter}>
          ...
          <Text style={styles.trustSubtext}>
            Offers from leading Indian banks & NBFCs for home loans
          </Text>
        </View>
...
export default HomeLoansScreen;
