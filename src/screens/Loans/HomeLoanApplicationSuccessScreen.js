/**
 * FYNP Home Loan Application Success Screen
 * Shows confirmation and next steps after home loan application submission
 */
...
const HomeLoanApplicationSuccessScreen = ({navigation, route}) => {
  const {applicationData} = route.params || {};

  // Generate Application ID
  const generateApplicationID = () => {
    const randomNum = Math.floor(Math.random() * 10000);
    return `HL-${Math.floor(Math.random() * 10000)}-${randomNum}`;
  };
    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.description}>
          Our home loan specialist will connect with you shortly to discuss
          property details and loan options.
        </Text>
...
export default HomeLoanApplicationSuccessScreen;
