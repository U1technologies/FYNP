/**
 * FYNP Education Loans Screen
 * Displays education loan offers from multiple lenders
 */
...
const EducationLoansScreen = ({navigation}) => {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Education Loans</Text>
      </View>
...
export default EducationLoansScreen;
